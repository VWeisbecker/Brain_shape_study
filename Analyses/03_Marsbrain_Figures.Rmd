...
text(-0.122, 0.01, labels = expression (italic("B. nalima")), col = "#CC0000" )
text(-0.13, -0.0035, labels = expression (italic("E.ima")), col = "#CC0000" )
lines(c(-0.0689497454, -0.105), c(0.0037306146, 0.009), col = "#CC0000" ) # Balbaroo
lines(c (-0.0589188992, -0.12), c(-0.0033289847, -0.0055),col = "#CC0000") #E.ima
...
png("../Figures/FigX_Volumes.png",width = 1040, height = 1100, units = "px", pointsize = 24)
  ...
  plot(PCA.vol$scores[,1],PCA.vol$scores[,2], asp=T, xlab= pc1lab.vol, ylab= pc2lab.vol, 
       pch = fos.gp, cex = 1.5, col=col.gp, bg = col.gp) # plots PCA
